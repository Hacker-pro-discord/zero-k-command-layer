...
function widget:Update()
	...
	local r={time=now,los=current/256,explored=explored/256,scoutVisited=scouted/256,known=known,economy=A.GetEconomyAutomationStatus(),production=A.GetProductionStatus()}

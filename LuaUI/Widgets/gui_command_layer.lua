...
function widget:Initialize()
	...
	C.structurePlanning=module('StructurePlanning')(C); C.nativeQueue=module('NativeQueue')(C); C.economyPlan=module('EconomyPlanning')(C); C.economy=module('Economy')(C); C.arsenal=module('Arsenal')(C); C.recovery=module('Recovery')(C); C.matchups=module('UnitMatchups')(C,module('CounterMatrixData')); C.enemyModel=module('EnemyModel')(C); C.productionControl=module('ProductionController')(C); C.militaryBudget=module('MilitaryBudget')(C); C.startup=module('Startup')(C); C.mapControl=module('MapControl')(C)

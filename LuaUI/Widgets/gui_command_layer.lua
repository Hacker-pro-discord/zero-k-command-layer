...
function widget:Update(dt) if not ready and C.ui then ready=C.ui.initialize() end; if ready then C.logistics.update(); C.observations.update(); C.officer.update(); C.proposals.update(); C.advisor.update(); C.ui.update(dt) end end

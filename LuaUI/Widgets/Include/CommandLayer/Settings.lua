return function(U)
	...
	function S.load(data)
		...
		for _,k in ipairs({'autoStructures','unitMatchups','autoPlay','autoEconomy','autoAssign','constructors','overlays','debug'}) do if type(data[k])=='boolean' then S[k]=data[k] end end
